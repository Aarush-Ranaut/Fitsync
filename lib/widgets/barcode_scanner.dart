...
//works without flask but for camera only
// import 'dart:convert';
// import 'dart:io';
// import 'package:flutter/material.dart';
// import 'package:google_mlkit_barcode_scanning/google_mlkit_barcode_scanning.dart';
...
//     // Step 2: If ingredients are missing, use Gemini API
...
//     // Step 3: Fetch calorie info if ingredients are available
...
//       _initializeCamera();
//     } else {
//       // Delay gallery scan until after first build to ensure widget is mounted
...
//                 children: [
//                   Text(
//                     "Scanned Barcode: ${_scannedBarcode ?? 'No barcode yet'}",
//                     style: GoogleFonts.roboto(
//                       fontSize: 18,
//                       fontWeight: FontWeight.bold,
//                       color: const Color(0xFF8ACA7A),
...
//                 const SizedBox(height: 24),
//               ],
//               if (_scannedBarcode != null || widget.scanFromGallery) ...[
//                 _buildResultCard(),
//                 const SizedBox(height: 24),
//               ],
//               if (!widget.scanFromGallery) Center(child: _buildButton()),
...
//above code works for both And GUI too
// import 'dart:convert';
// import 'dart:io';
// import 'package:flutter/material.dart';
// import 'package:google_mlkit_barcode_scanning/google_mlkit_barcode_scanning.dart';
...
// import 'package:image_picker/image_picker.dart';
// import 'package:google_fonts/google_fonts.dart';
// import 'calorie_calculator.dart'; // Assuming this exists from Code B

// class BarcodeScannerScreen extends StatefulWidget {
//   const BarcodeScannerScreen(
//       {super.key}); // No need for scanFromGallery parameter
...
//   Map<String, dynamic>? _productDetails; // Added to match original structure
...
class _BarcodeScannerScreenState extends State<BarcodeScannerScreen>
  ...
  Future<File> _preprocessImage(String filePath) async {
    try {
      ...
      final tempFile = File(
          '${tempDir.path}/processed_barcode_${DateTime.now().millisecondsSinceEpoch}.jpg');
      await tempFile.writeAsBytes(img.encodeJpg(resizedImage, quality: 90));

      print("Preprocessing complete: ${tempFile.path}");
      return tempFile;
    } catch (e) {
      print("Preprocessing error: $e");
      throw e; // Rethrow to handle in _scanBarcodeFromFile
    }
  }
