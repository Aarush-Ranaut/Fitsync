...
//   final String apiUrl = "http://192.168.0.105:5050/process_text";
//   File? _selectedImage;
...
//   File? _selectedImage;
//   String _extractedText = "Extracted text will appear here.";
//   String _normalIngredients = "Ingredients & details will appear here.";
//   String _calorieInfo = "Calorie information will appear here.";
//   bool _isProcessing = false;
...
//       String extractedText = await _extractText(_selectedImage!);
//       setState(() => _extractedText = _formatText(extractedText));

//       String ingredients = await _fetchIngredients(extractedText);
//       String calories = await _fetchCalories(ingredients);

//       setState(() {
//         _normalIngredients = _formatText(ingredients);
//         _calorieInfo = _formatText(calories);
//         _isProcessing = false;
//       });
//     }
//   }
...
class _OCRProcessorState extends State<OCRProcessor>
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (image != null) {
      ...
      setState(() {
        _normalIngredients = _formatText(ingredients);
        _calorieInfo = _formatText1(calories);
        _isProcessing = false;
      });
    }
  }
