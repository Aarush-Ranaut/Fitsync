...
//   final Function(String, int, int) onFoodAdded;
...
//           double caloriesPer100g = (item["foodNutrients"] as List)
//                   .firstWhere(
...
//   void _selectPredefinedFood(String name, double caloriesPer100g) {
//     _foodController.text = name;
//     _caloriesController.text = caloriesPer100g.toStringAsFixed(2);
//   }

//   void _addFoodEntry() {
//     String food = _foodController.text;
//     int grams = int.tryParse(_gramsController.text) ?? 0;
//     double caloriesPer100g = double.tryParse(_caloriesController.text) ?? 0.0;
//     int calories = ((caloriesPer100g * grams) / 100).round();

//     if (food.isNotEmpty && grams > 0) {
//       widget.onFoodAdded(food, grams, calories);
...
//         child: Column(
//           children: [
//             // Toggle Manual Entry or API Search
//             Row(
...
//               TextField(
//                 onChanged: (query) {
//                   if (query.length > 2) _fetchFoodData(query);
//                 },
...
//                       subtitle:
//                           Text("Calories per 100g: ${food['caloriesPer100g']}"),
//                       onTap: () {
...
//   final TextEditingController _caloriesController = TextEditingController();
//   List<Map<String, dynamic>> foodResults = [];
//   bool isSearching = false; // Track if the user is searching
...
//     _foodController.text = name;
//     _caloriesController.text = caloriesPer100g.toStringAsFixed(2);
//     setState(() => foodResults = []); // Hide results after selection
//   }
...
//                 labelText: 'Search or Enter Food Name',
...
// for Kcal, proteins, etc works for now
// import 'dart:convert';
// import 'package:flutter/material.dart';
// import 'package:http/http.dart' as http;
...
//     if (food.isNotEmpty && grams > 0) {
//       widget.onFoodAdded(food, grams, calories.round(), protein, fat, carbs);
//       Navigator.pop(context);
//     }
//   }
