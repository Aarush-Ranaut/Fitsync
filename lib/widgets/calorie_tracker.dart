//works well with input feilds and progress bars
...
//       setState(() {
//         dailyGoal =
//             (userDoc.data() as Map<String, dynamic>)['calorieGoal'] ?? 0;
//       });
//     } else {
//       _askForCalorieGoal();
//     }
...
//   Future<void> _askForCalorieGoal() async {
//     await showDialog(
//       context: context,
//       builder: (context) {
//         return AlertDialog(
//           title: const Text('Set Your Daily Calorie Goal'),
//           content: TextField(
...
//   Future<void> _addOrEditFoodEntry({String? docId}) async {
//     if (userId == null) return;
...
//     if (food.isEmpty || grams <= 0 || calories <= 0) return;
...
//           .doc(docId)
//           .update({
//         'foodName': food, // Allow editing food name too
//         'grams': grams,
//         'calories': calories,
//       });
//     }
...
//             ElevatedButton(
//               onPressed: () {
//                 _addOrEditFoodEntry(docId: food['id']);
//                 Navigator.pop(context);
//               },
//               child: const Text('Save'),
//             ),
...
//     int totalCalories = foodEntries.fold(
...
//                   ElevatedButton(
//                       onPressed: _askForCalorieGoal,
//                       child: const Text('Edit Calorie Goal')),
...
//               onPressed: () {
//                 _addOrEditFoodEntry(
//                   docId: food['id'], // Document ID for existing entry
//                   food: _foodController.text, // Updated food name
//                   grams:
//                       int.tryParse(_gramsController.text) ?? 0, // Updated grams
...
//           onFoodAdded: (String food, int grams, int calories) {
//             _addOrEditFoodEntry(food: food, grams: grams, calories: calories);
//           },
//         ),
//       ),
//     );
...
//   Future<void> _addFoodEntry(String food, int grams, int calories) async {
//     if (userId == null) return;
