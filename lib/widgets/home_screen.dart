...
// }
//latest with Above + Edit profile
// import 'package:fitsync_app/auth/signin.dart';
// import 'package:fitsync_app/widgets/exercise_selection.dart';
// import 'package:flutter/material.dart';
// import 'package:firebase_auth/firebase_auth.dart';
...
//     User? user = FirebaseAuth.instance.currentUser;
//     if (user == null) {
//       // If no user is logged in, redirect to SigninScreen
...
//     if (!userDoc.exists) {
//       _navigateToEditProfileAndReturn(context, user.uid);
//       return;
//     }
...
//   void _navigateToEditProfileAndReturn(BuildContext context, String userId) {
//     Navigator.pushReplacement(
//       context,
//       MaterialPageRoute(
//         builder: (context) => EditProfileScreen(userId: userId),
